...
async def async_evaluate_python_code(
    ...
    """
    기존 evaluate_python_code를 별도 스레드에서 실행하여 비동기적으로 평가합니다.
    """
...
class AsyncLocalPythonExecutor(PythonExecutor):
    def __init__(
        ...
        # static_tools는 도구들 + 안전한 내장 함수들을 포함합니다.
    ...
    def send_tools(self, tools: Dict[str, Tool]):
        # 안전한 내장 도구와 함께 static_tools에 설정합니다.
        self.static_tools = {**tools, **BASE_PYTHON_TOOLS.copy()}


__all__ = ["evaluate_python_code", "AsyncLocalPythonExecutor"]
