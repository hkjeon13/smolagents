...
import asyncio
from .async_monitoring import AsyncAgentLogger
...
class AsyncAgentError(Exception):
    ...
    def __init__(self, message, logger: "AsyncAgentLogger"):
        super().__init__(message)
        self.message = message
        asyncio.to_thread(logger.log_error, message)

    def dict(self) -> Dict[str, str]:
        return {"type": self.__class__.__name__, "message": str(self.message)}


class AsyncAgentParsingError(AsyncAgentError):
    """Exception raised for errors in parsing in the agent"""

    pass


class AsyncAgentExecutionError(AsyncAgentError):
    """Exception raised for errors in execution in the agent"""

    pass


class AsyncAgentMaxStepsError(AsyncAgentError):
    """Exception raised for errors in execution in the agent"""

    pass


class AsyncAgentGenerationError(AsyncAgentError):
...
async def async_make_init_file(folder: str):
