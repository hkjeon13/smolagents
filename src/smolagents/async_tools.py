...
class AsyncTool:
    ...
    @classmethod
    def from_dict(cls, tool_dict: dict[str, Any], **kwargs) -> "AsyncTool":
        """
    ...
    def from_hub(
        ...
        return AsyncTool.from_code(tool_code, **kwargs)
    ...
    def from_space(
        ...
        Examples:
        ```py
        >>> image_generator = AsyncTool.from_space(
...
def launch_gradio_demo(tool: AsyncTool):
    """
...
async def async_tool(tool_function: Callable) -> AsyncTool:
    """
